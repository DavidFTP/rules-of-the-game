...
export const ASSET_PATHS = {
  ...
  boxes: {
    ...
    default2: new URL('../assets/crates/default2.png', import.meta.url).href,
    default3: new URL('../assets/crates/default3.png', import.meta.url).href,
    default4: new URL('../assets/crates/default4.png', import.meta.url).href,
    blue:     new URL('../assets/crates/blue.png', import.meta.url).href,
    blue2:    new URL('../assets/crates/blue2.png', import.meta.url).href,
    blue3:    new URL('../assets/crates/blue3.png', import.meta.url).href,
    blue4:    new URL('../assets/crates/blue4.png', import.meta.url).href,
    red:      new URL('../assets/crates/red.png', import.meta.url).href,
    red2:     new URL('../assets/crates/red2.png', import.meta.url).href,
    red3:     new URL('../assets/crates/red3.png', import.meta.url).href,
    red4:     new URL('../assets/crates/red4.png', import.meta.url).href,
    grey:     new URL('../assets/crates/grey.png', import.meta.url).href,
    grey2:    new URL('../assets/crates/grey2.png', import.meta.url).href,
    grey3:    new URL('../assets/crates/grey3.png', import.meta.url).href,
    grey4:    new URL('../assets/crates/grey4.png', import.meta.url).href,
    target:   new URL('../assets/crates/target.png', import.meta.url).href,
    target2:  new URL('../assets/crates/target2.png', import.meta.url).href,
    target3:  new URL('../assets/crates/target3.png', import.meta.url).href,
    target4:  new URL('../assets/crates/target4.png', import.meta.url).href,
  },
  currency: {
    coin:     new URL('../assets/currency/lightcoin.png', import.meta.url).href,
    blue:     new URL('../assets/currency/blue.png', import.meta.url).href,
    brown:    new URL('../assets/currency/brown.png', import.meta.url).href,
    darkcoin: new URL('../assets/currency/darkcoin.png', import.meta.url).href,
    green:    new URL('../assets/currency/green.png', import.meta.url).href,
    grey:     new URL('../assets/currency/grey.png', import.meta.url).href,
    red:      new URL('../assets/currency/red.png', import.meta.url).href,
  },
  sprites: {
